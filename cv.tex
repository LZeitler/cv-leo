...
% run: xelatex cv.tex; okular cv.pdf # or pdflatex
...
\usepackage{fancyhdr}
\pagestyle{fancy}
%\AtBeginDocument{\thispagestyle{empty}} % for not having footer on first page
\fancyhf{}
\rfoot{CV Leo Zeitler $\cdot$ \thepage /\pageref*{LastPage}}
...
\setlength{\headheight}{12.0pt}      % fancyhdr avoid warning
\addtolength{\topmargin}{-12.0pt}
\renewcommand{\headrulewidth}{0pt}   % fancyhdr remove header
...
\moveleft.5\hoffset\centerline{University of Fribourg} % Your address
\moveleft.5\hoffset\centerline{Department of Biology} % Your address
\moveleft.5\hoffset\centerline{Chemin Du Musée 15} % Your address
\moveleft.5\hoffset\centerline{1700 Fribourg}
...
%\item \textbf{Zeitler, L.}, Parisod, C., and Gilbert, K.J. (2023). Purging due to self-fertilization does not prevent accumulation of expansion load. bioRxiv DOI:\href{https://www.biorxiv.org/content/10.1101/2022.12.19.521096v3}{\nolinkurl{10.1101/2022.12.19.521096}}
%\end{etaremune}
...
\section{Conference Presentations} % newest first
...
%---------------------------------------------------------------------------------------
%	Volunteer, Service, Outreach, Teaching, etc. SECTION
%----------------------------------------------------------------------------------------
